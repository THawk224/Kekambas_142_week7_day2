...
var heightsInFeet = heightsInInches.map(inch => inch / 12);

console.log(heightsInFeet); 
// A: [5.5, 5.333333333333333, 5, 4.333333333333333, 6, 6.666666666666667, 4.25]
...
console.log(reverseString(testString1)); // "dlroW olleH"
console.log(reverseString(testString2)); // "321 tset tset"
...
console.log(removeDuplicates(testArr1)); // ['Chicago', 'New York', 'Miami']

console.log(removeDuplicates(testArr2)); // [1, 2, 3, 4]